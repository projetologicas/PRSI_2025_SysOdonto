...
import { IconCalendar, IconUsers, IconClock, IconArrowRight } from "@tabler/icons-react";
            ...
            <div className="w-full lg:w-11">
                ...
                <Card>
                    <div className="flex flex-column md:flex-row md:align-items-center md:justify-content-between mb-4">
                        <h2 className="text-2xl font-bold text-900 m-0">Você tem {stats.todayConsultations} consultas hoje</h2>
                        <Button
